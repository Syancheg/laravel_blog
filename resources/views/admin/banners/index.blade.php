    ...
    <section class="content">
        <div class="container-fluid">
            <div class="col-4 mb-3">
                <a href="" class="btn bg-gradient-success"><i class="fas fa-plus"></i></a>
            ...
            <div class="col-12">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-button-block">
                                                <a href="{{ route('admin.banner.show', $banner->id) }}" class="btn bg-gradient-success"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('admin.banner.edit', $banner->id) }}" class="btn bg-gradient-primary"><i class="fas fa-pen"></i></a>
                ...
                @else
                    <div>
                        Тут пока нет ни одного баннера
                    </div>
                @endif
            </div>
        </div><!-- /.container-fluid -->
